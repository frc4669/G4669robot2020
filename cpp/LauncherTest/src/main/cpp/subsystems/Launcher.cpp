    ...
    : m_launcher{kLauncherMotorPort}
{
    ...
    m_launcher.SetSensorPhase(true);
    ...
    m_launcher.Config_kF(kPIDLoopIdx, 0.1097, kTimeoutMs);
    m_launcher.Config_kP(kPIDLoopIdx, 0.22, kTimeoutMs);
    m_launcher.Config_kI(kPIDLoopIdx, 0.0, kTimeoutMs);
    m_launcher.Config_kD(kPIDLoopIdx, 0.0, kTimeoutMs);
}
