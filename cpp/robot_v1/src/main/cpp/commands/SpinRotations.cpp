...
SpinRotations::SpinRotations(SpinnerHook * spinHook, double rotations) {
...
void SpinRotations::Initialize() {
  ...
  spinnerHook->InitSpinner();
  spinnerHook->SpinRotations(targetRotations);
}
